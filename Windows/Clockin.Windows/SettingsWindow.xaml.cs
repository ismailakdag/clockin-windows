...
public partial class SettingsWindow : Window
{
    ...
    private void Apply_Click(object sender, RoutedEventArgs e)
    {
        ...
        _store.UpdateRate(rate); _store.UpdateCurrency(Item(CurrencyBox, "USD")); _settings.Set("Theme", Item(ThemeBox, "Carbon")); _settings.Set("PinnedMode", Item(PinnedModeBox, "Money")); _settings.Set("PinnedFontSize", Item(PinnedFontSizeBox, "Comfortable")); _settings.Set("MascotDefault", Item(MascotDefaultBox, "Auto")); _settings.Set("MascotEnabled", MascotEnabled.IsChecked == true); _settings.Set("GoalDailyHours", Parse(DailyGoal.Text)); _settings.Set("GoalMonthlyHours", Parse(MonthlyGoal.Text)); _settings.Set("MinimalMode", MinimalMode.IsChecked == true); _settings.Set("MinimalShowHours", MinimalShowHours.IsChecked == true); _settings.Set("MinimalShowEarnings", MinimalShowEarnings.IsChecked == true); _settings.Set("MinimalShowTRY", MinimalShowTRY.IsChecked == true); _settings.Set("MinimalShowGoal", MinimalShowGoal.IsChecked == true);
