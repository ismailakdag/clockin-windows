...
public partial class ManualStartWindow : Window
{
    ...
    {
        if (!double.TryParse(Hours.Text, out var hours) || !double.TryParse(Minutes.Text, out var minutes) || hours < 0 || minutes < 0) { ClockinDialog.Alert(this, "Start with elapsed time", "Enter valid non-negative hours and minutes."); return; }
